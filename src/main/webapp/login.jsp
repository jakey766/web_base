                    ...
                    <div class="form-bottom">
                        <form role="form" action="" method="post" class="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="form-username" value="" placeholder="请输入用户名..." class="form-username form-control" id="form-username" onkeydown="if(event.keyCode==13){search()}">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">密码</label>
                                <input type="password" name="form-password" value="" placeholder="请输入密码..." class="form-password form-control" id="form-password" onkeydown="if(event.keyCode==13){login()}">
                            </div>
