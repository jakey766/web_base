...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            var divRowDef = '<div style="float:none; min-width: ' + divWidth + '%; " >';
            var divClose = '</div>';
            ...
            for (j = 0; j < iLen; j++) {
                ...
                r += '<label for="' + uniqueId + '_cb_' + sValue + '"><input class="search_init checkbox_filter" checked type="checkbox" id= "' + uniqueId + '_cb_' + sValue + '" name= "' + localLabel + '" value="' + sValue + '" ><span style="display:inline-block; margin:3px 0 0 5px; vertical-align: middle;">' + sLabel + '</span></label>';
            ...
            $('#' + buttonId).click(function () {
                ...
                var target = $(this);
                $('#' + checkToggleDiv).dialog("widget").position({ my: 'left top',
                    at: 'left bottom',
                    of: target
                });
